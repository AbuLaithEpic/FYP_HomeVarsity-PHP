...
<body>
    ...
    <div class="filter">
        <div class="custom-select" style="width:300px; margin-top:100px;">
            <select class="select-item" id="item-select" selected onchange="document.location = this.value">
                <option value="/homevarsity/listing-price-low-high.php" selected>Price : Low to High</option>
                ...
                <option value="/homevarsity/listing-distance-low-high.php">Distance: Low to High</option>
            </select>
        </div>
    </div>
    <div class="list-item">
